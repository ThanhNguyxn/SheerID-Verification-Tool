...
| [SheerID Discord Bot](https://discord.com/invite/7mt422QN9Y) | ⚡ Бот | Альтернативный Discord-бот с более быстрой обработкой |
| [SheerID VN Bot](https://t.me/SheerID_Verification_bot?start=ref_LdPKPES3Ej) | 🇻🇳 Бот | Telegram-бот вьетнамского сообщества |
| [Veterans Verify Bot](https://t.me/gpt_veterans_bot?start=ref_7762497789) | 🎖️ Бот | Бот для военной верификации |
